...
int mainmenu(void)
{
	...
	cprintf("\n\r%26s%c T Y P I N G   M A S T E R %c","",16,17);
...
{/* here the n user name list is displayed from the file ulist.dat
	...
	/*now allow the user to select correct user name from the list*/
...
void about(void)
{
   ...
   window(15,5,80,25);
   textcolor(LIGHTRED);
   cprintf("\n A B O U T   T Y P I N G   M S T E R");
	textcolor(LIGHTCYAN);
